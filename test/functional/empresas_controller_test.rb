...
class EmpresasControllerTest < ActionController::TestCase
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post :create, empresa: { cnpj: @empresa.cnpj, identificador: @empresa.identificador, nome: @empresa.nome }
    end
  ...
  test "should update empresa" do
    put :update, id: @empresa, empresa: { cnpj: @empresa.cnpj, identificador: @empresa.identificador, nome: @empresa.nome }
    assert_redirected_to empresa_path(assigns(:empresa))
  end
